...
% Last Modified by GUIDE v2.5 17-Feb-2015 13:01:03
...
if isequal(FileName,0)
    ...
    try
        % Initialize parameters from init.json
         [ASR, Loc, Out, Comment, IP] = ReadInitFile(FileName);
        ...
        handles.SMeasure = ASR; handles.LMeasure = Loc; handles.OMeasure = Out;
        handles.CMeasure = Comment; handles.WMeasure = IP; setappdata(handles.figure1, 'state', 0);
...
setappdata(handles.figure1, 'state', 0); guidata(hObject, handles);
