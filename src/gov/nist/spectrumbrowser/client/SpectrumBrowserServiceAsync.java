...
public interface SpectrumBrowserServiceAsync {
	...
	/**
	 * Authenticates a user given user name and password. Returns an
	 * authentcation token (sessionId) to be used in all subsequent
	 * interactions.
	 * 
	 * 
	 * @param name
	...
	void getLocationInfo(String sessionId,
			SpectrumBrowserCallback<String> SpectrumBrowserCallback)
			throws IllegalArgumentException;

	/**
	 * Gets the record count (number of scans) for a given location between the
	 * given time limits.
	 * 
	 * @param lat
	 *            -- location lat
	 ...
	 *            -- location altitude
	 * @param minTime
	 *            -- min time ( ref jan 1 1970 miliseconds) of interval
	 * @param maxFreq
	 * @param minFreq
	 * @param maxTime
	 *            -- max time of interval
	 * @return -- json formatted string containing the record count.
	 * @throws IllegalArgumentException
	 */

	void getDataSummary(String sensorId, double lat, double lng, double alt,
	 ...
	 *            -- location
	 * @param time
	 *            -- time for the spectrum
	 * @param freq
	 *            -- freq for the occupancy
	 * @param minFreq
	 *            -- minFreq for the spectrum
	 * @param maxFreq
	 *            -- maxFreq for the spectrum
	 * @param minTime
	 *            -- min time for the occupancy chart.
	 * @param maxTime
	 *            -- max time for the occupancy chart.
	 * @return -- json formatted string containing the occupancy and spectrum.
	 * @throws IllegalArgumentException
	 */

	void getPowerVsTimeAndSpectrum(String sensorId, long time, long freq,
	...
	void generateDailyStatistics(String sensorId, long minDate, long minFreq,
			long maxFreq, int minPower, SpectrumBrowserCallback<String> callback)
			throws IllegalArgumentException;
	 ...
	 * 
	 */
	void getDailyMaxMinMeanStats(String sensorId, double latitude,
			double longitude, double altitude, long minDate, long ndays,
			String sys2detect, long minFreq, long maxFreq, long subBandMinFreq,
			long subBandMaxFreq, SpectrumBrowserCallback<String> callback)
			throws IllegalArgumentException;
	 ...
	 * @param sensorId
	 * @param startTime
	 *            - some time during the day for which data is needed.
	 * @param sys2detect
	 * @param maxFreq
	 * @param minFreq
	 * @param callback
	...
	void generateSingleAcquisitionSpectrogramAndOccupancy(String sensorId,
			...
			long mMaxFreq, SpectrumBrowserCallback<String> callback)
			throws IllegalArgumentException;
	 ...
	 * 
	 * @param sessionId
	 *            - session ID for current login.
	 * @param mSensorId
	 *            - sensor ID
	 * @param mSelectionTime
	 *            - selection time.
	 * @param maxFreq
	 *            - max Freq of the acquisition.
	 * @param minFreq
	 *            - min freq of the acquisition.
	 * @param callback
	 *            -- the callback.
	 */
	void generateSingleAcquisitionSpectrogramAndOccupancy(String sensorId,
	 ...
	 *            - time of acquisition.
	 * @param minFreq
	 *            - min freq of acquisition.
	 * @param maxFreq
	 *            - max freq of acquisition.
	 * @param leftBoundary
	 *            - left boundary of time window ( milliseconds)
	 * @param rightBoundary
	 *            - right boundary of time window (milliseconds)
	 * @param cutoff
	 * @param callback
	 */
	void generateSingleAcquisitionSpectrogramAndOccupancy(String sensorId,
			long selectionTime, String sys2detect, long minFreq, long maxFreq,
			int leftBoundary, int rightBoundary, int cutoff,
			SpectrumBrowserCallback<String> callback);
	 ...
	 * @param callback
	 */
	void generateSpectrum(String sensorId, long startTime,
	 ...
	 */
	void generateSpectrum(String sensorId, long startTime,
			long milisecondOffset, long minFreq, long maxFreq,
			SpectrumBrowserCallback<String> callback);
	 ...
	 * @param callback
	 */
	void getCaptureEvents(String sensorId, long startTime, int dayCount,
			SpectrumBrowserCallback<String> callback);
	 ...
	 * @param callback
	 */
	void emailUrlToUser(String sensorId, String uri, String emailAddress,
			SpectrumBrowserCallback<String> callback);
	 ...
	 *            -- session ID.
	 * @param uri
	 *            -- URI to check for the dump (the last part of the URL).
	 * @param callback
	 *            -- the call back to call on response from the server.
	 */

	void checkForDumpAvailability(String sensorId, String uri,
			SpectrumBrowserCallback<String> callback);
	 ...
	 * @param minFreq
	 */
	void getLastAcquisitionTime(String sensorId, String sys2Detect,
			long minFreq, long maxFreq, SpectrumBrowserCallback<String> callback);
	 ...
	 * @param sensorId
	 */
	void getLastAcquisitionTime(String sensorId,
			SpectrumBrowserCallback<String> callback);
	 ...
	 * @param spectrumBrowserCallback
	 */
	void getAcquisitionCount(String sensorId, double lat, double lon,
			double alt, String sys2Detect, long minFreq, long maxFreq,
			long selectedStartTime, int dayCount,
			SpectrumBrowserCallback<String> spectrumBrowserCallback);
	 ...
	 * @param urlPrefix
	 */
	void requestNewAccount(String jsonContent,
			SpectrumBrowserCallback<String> spectrumBrowserCallback);
	 ...
	 * @param urlPrefix
	 */
	void changePassword(String jsonContent,
			SpectrumBrowserCallback<String> spectrumBrowserCallback);
	 ...
	 * @param urlPrefix
	 */
	void requestNewPassword(String jsonContent,
			SpectrumBrowserCallback<String> spectrumBrowserCallback);
	 ...
	 * @param spectrumBrowserCallback
	 */
	public void logOff(String sensorId,
			SpectrumBrowserCallback<String> spectrumBrowserCallback);
